...
setup(
    ...
    url='https://github.com/KELLERStephane/KELLER-Stephane-Tests2maths/tree/master/7%20-%20Raspberry%20Pi/Ressources',
    ...
    entry_points = {
        'console_scripts': [
            'moonsk = moonssk.moonssk:lunar_phase(day=24, month=5, year=1969)',
        ],
    },
